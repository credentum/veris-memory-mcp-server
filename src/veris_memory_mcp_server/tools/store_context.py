...
class StoreContextTool(BaseTool):
    ...
    async def execute(self, arguments: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            if "*" not in self.allowed_context_types and context_type not in self.allowed_context_types:
                raise ToolError(
                    f"Context type '{context_type}' not allowed. Allowed types: {self.allowed_context_types}",
